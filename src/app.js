  ...
  function howToPlayModal() {
    modal({
      ...
      body:
        ...
        '<h4>Share it</h4><p class="muted small">This whole trainer is one web page — send it to a classmate: <b>codedbytahir.github.io/beast-chess</b>. ' +
        'Prefer it offline? Download <b>beast-chess.html</b> from that page and open the file anywhere; your progress saves in your own browser on this device.</p>',
      buttons: [
